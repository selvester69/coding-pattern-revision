...
public class P046PreOrderTraversal {
    ...
    public static void main(String[] args) {
        P046PreOrderTraversal traversal = new P046PreOrderTraversal();
        ...
        test(traversal, root3, new Integer[]{1, 2, 3});
        ...
        test(traversal, root5, new Integer[]{1, 2, 3});
        ...
        test(traversal, root6, new Integer[]{1, 2, 4, 5, 3});
        ...
        test(traversal, root7, new Integer[]{1, 4, 2, 3});
        ...
        test(traversal, root8, new Integer[]{1, 2, 4, 5});

    }

    private static void test(P046PreOrderTraversal traversal, TreeNode root, Integer[] expected) {
        List<Integer> actual = traversal.preorderTraversal(root);
