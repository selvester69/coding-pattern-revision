...
public class P047PostOrderTraversal {
    ...
    public static void main(String[] args) {
        P047PostOrderTraversal traversal = new P047PostOrderTraversal();
        ...
        test(traversal, root5, new Integer[]{2, 3, 1}); // Postorder: Left, Right, Root
        ...
        test(traversal, root6, new Integer[]{4, 5, 2, 3, 1});
        ...
        test(traversal, root7, new Integer[]{4, 3, 2, 1});
        ...
        test(traversal, root8, new Integer[]{4, 5, 2, 1});
    }

    private static void test(P047PostOrderTraversal traversal, TreeNode root, Integer[] expected) {
        List<Integer> actual = traversal.postorderTraversal(root);
